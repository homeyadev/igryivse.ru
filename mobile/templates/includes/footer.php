<footer>
    <a href="/"><img src="sources/avatar.png" id="foot-logo"></a>

    <h1 class="foot-header">Основное</h1>
    <h1 class="foot-header">Внешние ссылки</h1>
    ...
    <h3 class="external-link"><a href="https://github.com/intel-boy" target="_blank">GitHub</a></h3>

    <h5 id="not-real">Все графические изображения и словесные обозначения брендов принадлежат их правообладателям.</h5>
</footer>